**************************************************************************************************************
***PRE-ANALYSIS ADJUSTMENTS TO THE CAR SALES INDEX***	
...
set more off
	...
	*Import Car Sale Data 
		use "/Users/laurenschmitz/Dropbox/2022_ACTIVE_PROJECTS/Duque_&_Schmitz/GD_Epigenetic_Clocks_Project/Data/Raw_Car_Sales_Data.dta"
			*Data source: J. K. Hausman, Fiscal Policy and Economic Recovery: The Case of the 1936 Veterans’ Bonus. Am. Econ. Rev. 106, 1100–1143 (2016)
	...
	*Create car sale index with 1929 as the base year
		gen car_sales29=car_sales if birthyr==1929
			bysort st_born2: egen maxcar_sales29=max(car_sales29)
		gen car_salesi=car_sales/maxcar_sales29
	
	*Create event time study variables
		foreach var of varlist car_salesi {
	...
	*Drop variables not needed
		drop car_sales29 maxcar_sales29

	*Label variables
		label var car_sales "Number of cars sold"
		label var car_salesi "Car sale index in the YOB (t)"
		label var car_salesi_1 "Car sale index at t-1"
		label var car_salesi_2 "Car sale index at t-2"
		label var car_salesi_3 "Car sale index at t-3"
		label var car_salesi1 "Car sale index at t+1"
		label var car_salesi2 "Car sale index at t+2"
		label var car_salesi3 "Car sale index at t+3"
		label var car_salesi4 "Car sale index at t+4"
		label var car_salesi5 "Car sale index at t+5"
		label var car_salesi6 "Car sale index at t+6"

		label var birthyr "Year of birth"
		label var st_born_name "State of birth name"
		label var st_born2 "HRS state of birth code"
		
save "/Users/laurenschmitz/Dropbox/2022_ACTIVE_PROJECTS/Duque_&_Schmitz/GD_Epigenetic_Clocks_Project/Data/Car_Sale_Index_Data_w_ETS_FINAL.dta", replace
